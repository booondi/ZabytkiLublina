...
<main>
    ...
    <hr>
    <h2><center>Usuń zdjęcie z bazy</center></h2>
    Podaj dokładną nazwę pliku, który chcesz usunąć (wraz z rozszerzeniem):<br> <form action="usunzdj.php" method="post"><input type="text" name="nazwa" size="50"><input type="submit" value="Usuń zdjęcie"><br><hr>
    <?php
 $katalog="zdjecia/";
